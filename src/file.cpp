...
const SolveSpaceUI::SaveTable SolveSpaceUI::SAVED[] = {
    ...
    { 'g',  "Group.expressionA",        'S',    &(SS.sv.g.expressionA)        },
    { 'g',  "Group.expressionB",        'S',    &(SS.sv.g.expressionB)        },
    { 'g',  "Group.expressionC",        'S',    &(SS.sv.g.expressionC)        },
    { 'g',  "Group.exprAScalingToBase", 'f',    &(SS.sv.g.exprAScalingToBase) },
    { 'g',  "Group.exprBScalingToBase", 'f',    &(SS.sv.g.exprBScalingToBase) },
    { 'g',  "Group.exprCScalingToBase", 'f',    &(SS.sv.g.exprCScalingToBase) },
