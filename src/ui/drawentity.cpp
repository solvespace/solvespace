...
// CalculateNumerical is now on EntityBase and implemented in core/entity.cpp.
// ComputeInterpolatingSpline, GenerateBezierCurves, and GenerateEdges
// are now on EntityBase and implemented in core/entity.cpp.
