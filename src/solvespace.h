...
public:
    ...
    // group
    inline void AddGroup(GroupBase *g) {
        group.AddAndAssignId(g);
    }

    inline void SetActiveGroup(GroupBase *g) {
        activeGroup = g;
    }

    inline GroupBase* GetActiveGroup() {
        return activeGroup;
    }
    ...
    inline ConstraintBase AddConstraint(
        ConstraintBase::Type type, EntityBase workplane, double val, EntityBase ptA,
